...
/**
 * WhiteRabbit\Model\Behavior\UploadableBehavior Test Case
 *
 */
class UploadableBehaviorTest extends TestCase
{
    ...
    public function testSaveWithFile()
    {
        ...
        $data = [
            ...
            'body' => 'Content',
            'file' => [
                'name' => 'WhiteRabbit.png',
                'type' => 'image/png',
                'tmp_name' => 'somepath/WhiteRabbit.png',
                'error' => 0,
                'size' => 11501,
            ]
        ];
        ...
        $this->assertContains('/uploads/articles/3/WhiteRabbit.png', $get->get('url'));
        ...
        $this->assertContains('WhiteRabbit.png', $get->get('file_name'));
        $this->assertContains('uploads' . DS . 'articles' . DS . '3' . DS . 'WhiteRabbit.png', $get->get('file_path'));
    }
}
